...
import { ShieldOrb } from "@/components/shield-orb";

export const Route = createFileRoute("/auth")({
  head: () => ({
    meta: [
      { title: "Access // SOCMINT Shield" },
      {
        name: "description",
        content:
          "Authorized personnel access for SOCMINT Shield — OSINT aggregation, risk scoring, and evidence chain for cleared operators.",
      },
      { property: "og:title", content: "Access // SOCMINT Shield" },
      {
        property: "og:description",
        content: "Sign in or request clearance to the SOCMINT Shield dossier.",
      },
        ...
        <aside className="relative hidden flex-col bg-sidebar text-sidebar-foreground lg:flex">
          ...
          <div className="relative flex flex-1 flex-col justify-between p-10 xl:p-14">
            ...
            <div className="relative flex items-end justify-between">
              ...
              <ShieldOrb className="anim-float-3d -mr-4 -mb-2" size={170} />
            </div>
          </div>
          <div className="classified-banner" />
        </aside>
